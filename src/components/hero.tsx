  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-32 pb-24 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="max-w-[820px] text-center relative z-10">
        ...
        <p className="text-[1.15rem] text-[var(--text-muted)] max-w-[600px] mx-auto mb-8 leading-[1.7]">
          Projekty, castingi, artyści, dni zdjęciowe. Zarządzaj agencją bez Excela, bez chaosu.
        </p>
        <div className="inline-flex items-center gap-2 py-1.5 px-4 bg-[var(--surface)] border border-[var(--border)] rounded-full text-[0.95rem] text-[var(--text-muted)] mb-8 font-medium">

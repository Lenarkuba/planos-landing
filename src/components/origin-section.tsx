export function OriginSection() {
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 max-w-[800px] mx-auto">
      <blockquote className="bg-[var(--bg-card)] border border-[var(--border)] rounded-[20px] p-8 md:p-14 relative overflow-hidden">
        <div
        ...
        <div className="text-[var(--text-muted)] text-[0.95rem] leading-[1.8] mt-6 space-y-4 italic">
          ...
          <p>
            PlanOS to system zaprojektowany od zera dzięki otwartej współpracy dla polskiego rynku — z&nbsp;obsługą PESEL-i, eksportem do ZUS, i&nbsp;ze zrozumieniem jak naprawdę wygląda praca agencji castingowej w&nbsp;Polsce.
          </p>
        </div>
